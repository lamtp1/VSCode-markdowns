...
while offset <  250:
    ...
    for id in rp2:
        ...
        for index, row in df.iterrows():
            sql = "INSERT INTO Device_test_2 (device_id, device_name, device_type, device_type_manufacture, device_role) VALUES (%s, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE device_name = %s, device_type = %s, device_type_manufacture = %s, device_role = %s"
