...
instance_id_file = open("instance_id_file_3.txt", "r", encoding='UTF-8')
device_file = open("device_namph17_3.txt", "w+", encoding='UTF-8')
for instance_id in instance_id_file: 
    ...
    if rp2['primary_ip4'] != None:
        ...
        if tenant == None:
            s =  instance_id + '|' + instance_name + '|' + primary_ip + '|' + loai + '|' + site +  '|' + device_type + "|" + owner + '\n'
        else:
            s =  instance_id + '|' + instance_name + '|' + primary_ip + '|' + loai + '|' + site +  '|' + device_type + "|" + tenant + '|' + owner +'\n'
