...
IPMS_SW_CPU_hour_2_url = 'http://192.168.251.20/api/?api=get_cus_group_peak&gr=23599'   # neu la CPU thi 'cus', BW thi 'int'


IPMS_SW_CPU_hour_2 = open("IPMS_SW_CPU_hour_2.txt", "w+", encoding = 'UTF-8')
headers = {
...
rp1 = requests.request("GET",IPMS_SW_CPU_hour_2_url, headers=headers).json()
for x in rp1:
...
# cnx.close()
    ...
    IPMS_SW_CPU_hour_2.write(s)
    
IPMS_SW_CPU_hour_2.close()
