...
IPMS_FW_BW_hour_url = 'http://192.168.251.20/api/?api=get_int_group_peak&gr=23587'   # neu la CPU thi 'cus', BW thi 'int'


IPMS_FW_BW_hour = open("IPMS_FW_BW_hour.txt", "w+", encoding = 'UTF-8')
headers = {
...
rp1 = requests.request("GET",IPMS_FW_BW_hour_url, headers=headers).json()
for x in rp1:
...
# cnx.close()
    ...
    IPMS_FW_BW_hour.write(s)
    
IPMS_FW_BW_hour.close()
