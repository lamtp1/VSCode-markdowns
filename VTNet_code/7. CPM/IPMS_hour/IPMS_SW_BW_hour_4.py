...
IPMS_SW_BW_hour_4_url = 'http://192.168.251.20/api/?api=get_int_group_peak&gr=23617'   # neu la CPU thi 'cus', BW thi 'int'


IPMS_SW_BW_hour_4 = open("IPMS_SW_BW_hour_4.txt", "w+", encoding = 'UTF-8')
headers = {
...
rp1 = requests.request("GET",IPMS_SW_BW_hour_4_url, headers=headers).json()
for x in rp1:
...
# cnx.close()
    ...
    IPMS_SW_BW_hour_4.write(s)
    
IPMS_SW_BW_hour_4.close()
