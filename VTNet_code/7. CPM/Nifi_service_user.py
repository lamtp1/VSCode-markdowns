...
while offset <  ip_count:
    ...
    for id in rp2:
        ...
        for index, row in df.iterrows():
            sql = "INSERT INTO Service_User (Service_user_ID, Service_ID, Instance_id, Username) VALUES (%s, %s, %s, %s) ON DUPLICATE KEY UPDATE  Service_ID=%s, Instance_id=%s, Username=%s"
