...
IPMS_FW_CPU_hour_url = 'http://192.168.251.20/api/?api=get_cus_group_peak&gr=23593'   # neu la CPU thi 'cus', BW thi 'int'
...
rp1 = requests.request("GET",IPMS_FW_CPU_hour_url, headers=headers).json()
for x in rp1:
    id = str(x['id'])
